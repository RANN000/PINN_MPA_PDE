...
def main():
    ...
    print(f"\n训练结果已保存至\'results/task2_mffm_mpa_improved\'")
...
def visualize_results(X_test, u_true, u_pred, train_loss, test_loss, save_dir ,k):
    ...
    plt.tight_layout()
    plt.savefig(save_dir / f'mffm_results_k{k}_improved.png', dpi=150)
    print(f"   结果已保存到: {save_dir / f'mffm_results_k{k}_improved.png'}")
    plt.close()
